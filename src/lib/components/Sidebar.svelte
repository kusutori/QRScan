...
<aside class="hidden md:flex flex-col w-64 bg-slate-900 dark:bg-slate-950 text-slate-300 h-screen sticky top-0 shrink-0 overflow-y-auto border-r border-slate-800 dark:border-slate-800">
  <div class="p-6">
    ...
    <nav class="space-y-2">
      {#each navItems as item}
        ...
        >
          <Icon size={20} class={isActive ? 'text-white' : 'text-slate-400 group-hover:text-white transition-colors'} />
